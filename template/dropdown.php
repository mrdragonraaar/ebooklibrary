...
<?php } else { ?>
<a title="<?php echo basename(current_url()); ?>" id="collapsed" class="basemenu"><img src="<?php echo ICON_DIR_OPEN; ?>"/><?php echo Dropdown::label(basename(current_url())); ?></a>
<?php } ?>
<!-- END Base Menu -->
<?php
$path = rtrim(dirname(current_url()), '/') . '/';
...
<!-- Site Menu Item -->
<li><a title="<?php echo SITE_TITLE; ?>" href="<?php echo SITE_URL; ?>"><img src="<?php echo ICON_SITE; ?>"/><?php echo Dropdown::label(SITE_TITLE); ?></a></li>
<!-- END Site Menu Item -->
</ul>
</div>
<!-- END Submenu -->
